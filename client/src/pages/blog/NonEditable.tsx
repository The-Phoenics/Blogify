...
function NonEditable({ blogData, setBlogData }) {
    ...
    return (
        <div className="px-16 max-w-[2100px]">
            <article>
                <h1 className="text-2xl font-bold text-gray-900 mb-4 border-none">{blogData?.title}</h1>
                ...
                <Editor editable={false} className="text-gray-800 text-lg text-left leading-relaxed mb-6">
                    {blogData?.content}
                </Editor>
            </article>
            <hr />
